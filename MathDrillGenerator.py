...
def build_drill_tex():
    """
    Create a .tex file that will build the drill (DEPRECATED)
    """
    pass
...
def compile_latex():
    """
    Use command line argument to compile the generated tex file with pdflatex (DEPRECATED)
    """
...
def build_drill(drill_type, compile_type, params):
    ...
    if compile_type == "latex":
        ...
        AbstractDrill.import_drill(drill_type).build_drill_pdf(params)